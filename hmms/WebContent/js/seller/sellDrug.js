...
$(function() {
	...
	function loaddata() {
		...
		$.post(
						'/hmms/service/drugIn/getUSDrugInfo',
						parm,
						function(result) {
							if (result.state == "0") {
														...
														if (layEvent === 'edit') {
															...
															$.post('/hmms/service/returnDrug/getReturAmount',
																	 ...
																	 function(result) {
																		 ...
																		 console.log(returAmount);
																		 var restAmount = Number(amount)-Number(returAmount);
	...
	layui.use('form', function() {
		...
		form.on('submit(formSubmit)', function(par) {
			...
			var data = par.field;
				...
				data.allprice = $('#txtAllprice').val();
				console.log(app.editData);
				$.post('/hmms/service/sellDrug/addSellDrug', data, function(result) {
					if (result.state == "0") {
